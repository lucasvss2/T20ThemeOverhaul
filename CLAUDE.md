...
- **Fases seguintes (NÃO implementadas):** instrumentos **Cítara Heptatônica** (+2 CD da 1ª habilidade mágica do aliado — one-shot/cross-actor), **Flauta Sar-Allan** (+5 Atuação só vs répteis — situacional), **Violino Soprano** (+1d4 no PRÓXIMO teste de perícia — consume-after-one-use) ficaram de fora por terem semântica "próximo/primeiro/condicional" que não cabe numa AE estática; **Trombeta Tapistana** dispensada pelo usuário. Materiais Aço-Rubi/Madeira Tollon/Matéria Vermelha/Mitral.
