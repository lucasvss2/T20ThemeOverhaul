...
- **Trade-off aceito:** sem chat/log/scene-controls na aba Mapa — é visualização + navegação de token, não uma ficha completa do GM. Combina com o gap já documentado da Fase 2 (sem chat em modo mobile, ponto nenhum).
