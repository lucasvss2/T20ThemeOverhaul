...
function powerItem(actorId, {
    ...
    resistPericia = "", resistTxt = "", dmgFormula = "", dmgTipo = "", descricao,
}) {
    const id = makeId();
    ...
    return {
        ...
        system: {
            ativacao: { execucao, custo: 0, condicao: "", qtd: "", special: "" },
...
NPCS.push({
    ...
    atributos: { for: 3, des: 0, con: 4, int: 1, sab: 5, car: 2 }, conjuracao: "sab",
    pericias: {
        ...saves(15, 8, 21),
    ...
    items: [
        ...
        { kind: "power", name: "Tempestade de Areia", execucao: "standard", alcance: "Médio (18m)", area: "Círculo 6m", resistPericia: "refl", resistTxt: "Reflexos CD 28 reduz à metade", dmgFormula: "4d6", dmgTipo: "impacto", descricao: "<strong>Padrão, 1×/cena.</strong> Uma nuvem de areia cortante e escaldante explode num círculo de 6m. <strong>Reflexos CD 28</strong> reduz o dano à metade; quem falha fica <strong>Ofuscado</strong> até o fim do próximo turno. Habilidade mágica." },
...
NPCS.push({
    ...
    atributos: { for: 4, des: 0, con: 3, int: 1, sab: 1, car: 3 }, conjuracao: "sab",
    pericias: {
        ...saves(17, 5, 11),
    ...
    items: [
        ...
        { kind: "power", name: "Explosão de Chamas Purista", execucao: "standard", alcance: "Pessoal", area: "Cone 6m", resistPericia: "refl", resistTxt: "Reflexos CD 20 reduz à metade", dmgFormula: "4d6", dmgTipo: "fogo", descricao: "<strong>Padrão, 1×/cena.</strong> Herwin conjura um cone de fogo sagrado-purista de 6m. <strong>Reflexos CD 20</strong> reduz o dano à metade. Habilidade mágica." },
        ...
        { kind: "power", name: "Comando Purista", execucao: "free", resistPericia: "", descricao: "<strong>Ação livre, 1×/cena.</strong> Até 3 aliados próximos (9m) recebem <strong>+2</strong> em testes de ataque até o início do próximo turno de Herwin." },
...
NPCS.push({
    ...
    atributos: { for: -1, des: 2, con: 0, int: 2, sab: 1, car: 3 },
    pericias: {
        ...saves(2, 13, 7),
    ...
    items: [
        ...
        { kind: "power", name: "Sumiço Discreto", execucao: "move", descricao: "<strong>Movimento, 1×/cena.</strong> Jacelin desaparece entre a movimentação do saguão, tornando-se impossível de localizar por 1 rodada." },
...
NPCS.push({
    ...
    atributos: { for: 0, des: 5, con: 1, int: 3, sab: 2, car: 4 },
    pericias: {
        ...saves(12, 26, 20),
    ...
    items: [
        ...
        { kind: "power", name: "Golpe Fatal", execucao: "free", descricao: "<strong>Ação livre, 1×/cena.</strong> O próximo ataque de Kara Thur que acertar é automaticamente um crítico." },
...
NPCS.push({
    ...
    atributos: { for: -2, des: 1, con: 2, int: 8, sab: 4, car: 3 }, conjuracao: "int",
    pericias: {
        ...saves(15, 28, 22),
    ...
    items: [
        ...
        { kind: "power", name: "Explosão Cataclísmica", execucao: "standard", alcance: "Longo (54m)", area: "Círculo 12m", resistPericia: "refl", resistTxt: "Reflexos CD 42 reduz à metade", dmgFormula: "10d10", dmgTipo: "arcano", descricao: "<strong>Padrão, 1×/cena.</strong> Uma explosão devastadora de energia arcana pura. <strong>Reflexos CD 42</strong> reduz o dano à metade. Habilidade mágica." },
        { kind: "power", name: "Escudo Arcano", execucao: "reaction", descricao: "<strong>Reação, 1×/cena.</strong> Quando é atingido por um ataque, Astralos reduz o dano recebido à metade." },
        { kind: "power", name: "Teleporte Instantâneo", execucao: "move", descricao: "<strong>Movimento, 1×/cena.</strong> Astralos se teleporta até 18m, ignorando obstáculos e terreno difícil. Habilidade mágica." },
...
NPCS.push({
    ...
    atributos: { for: 0, des: 6, con: 1, int: 2, sab: 3, car: 1 }, conjuracao: "int",
    pericias: {
        ...saves(10, 22, 16),
    ...
    items: [
        ...
        { kind: "power", name: "Flecha Explosiva", execucao: "standard", alcance: "Longo (54m)", area: "Círculo 3m", resistPericia: "refl", resistTxt: "Reflexos CD 30 reduz à metade", dmgFormula: "6d6", dmgTipo: "arcano", descricao: "<strong>Padrão, 1×/cena.</strong> Uma flecha explode numa pequena área ao atingir o alvo. <strong>Reflexos CD 30</strong> reduz o dano à metade. Habilidade mágica." },
...
NPCS.push({
    ...
    atributos: { for: 4, des: 0, con: 3, int: 0, sab: 1, car: -1 },
...
NPCS.push({
    ...
    atributos: { for: -1, des: 3, con: 0, int: 5, sab: 1, car: 1 },
    ...
    items: [
        ...
        { kind: "power", name: "Engenhoca de Emergência", execucao: "standard", descricao: "<strong>Padrão, 1×/cena.</strong> Megarah arremessa um dispositivo que concede <strong>+5</strong> na Defesa de um aliado até o início do próximo turno dele." },
...
NPCS.push({
    ...
    atributos: { for: -1, des: 2, con: 0, int: 2, sab: 1, car: 4 }, conjuracao: "car",
    ...
    items: [
        ...
        { kind: "power", name: "Truque de Cartas", execucao: "standard", resistPericia: "vont", resistTxt: "Vontade CD 22 nega", descricao: "<strong>Padrão, 1×/cena.</strong> Um alvo em alcance curto fica <strong>Desprevenido</strong> por 1 rodada. <strong>Vontade CD 22</strong> nega. Habilidade mágica." },
...
function staff8(name, raca, ability, atributos, periciaOverrides, img) {
    NPCS.push({
        ...
        atributos, pericias: { ...saves(1, 10, 5), ...periciaOverrides }, pv: 9,
        items: [
...
staff8("Liana", "Humana",
    { kind: "power", name: "Toque Revigorante", execucao: "standard", descricao: "<strong>Padrão, 1×/dia.</strong> Uma bebida especial preparada por Liana cura <strong>1d6</strong> pontos de vida de quem a bebe." },
...
NPCS.push({
    ...
    atributos: { for: 3, des: -1, con: 3, int: 0, sab: 0, car: -1 },
...
NPCS.push({
    ...
    atributos: { for: -2, des: 4, con: 0, int: 1, sab: 1, car: 2 },
...
NPCS.push({
    ...
    atributos: { for: 1, des: 1, con: 2, int: -1, sab: 0, car: -2 },
...
function staff10(name, raca, ability, atributos, periciaOverrides) {
    NPCS.push({
        ...
        atributos, pericias: { ...saves(14, 9, 4), ...periciaOverrides }, pv: 21,
        items: [
...
NPCS.push({
    ...
    atributos: { for: 3, des: 1, con: 3, int: -1, sab: 3, car: 0 },
    ...
    items: [
        ...
        { kind: "power", name: "Sopro Tormentoso", execucao: "standard", alcance: "Pessoal", area: "Cone 6m", resistPericia: "refl", resistTxt: "Reflexos CD 20 reduz à metade", dmgFormula: "4d6", dmgTipo: "trevas", descricao: "<strong>Padrão, 1×/cena.</strong> Vaskrith expele um cone de energia corrompida pela Tormenta. <strong>Reflexos CD 20</strong> reduz o dano à metade. Habilidade mágica." },
